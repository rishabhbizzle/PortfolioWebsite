...
import NotesApp from "../assets/anya.jpg";
import QuoteApp from "../assets/quotes.jpg";
import SpotApp from "../assets/spot.jpg";
import Jdbs from "../assets/jdbs.jpg";
    ...
    <div className="mt-20 md:mb-32 w-full md:h-screen text-gray-300 bg-[#0a192f]">
      ...
      <div  className="py-32 max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://spotanalytics.azurewebsites.net/">
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${Jdbs})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://jbspotifydata.com/">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${QuoteApp})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://anime-insta-captions.netlify.app/">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/rishabhbizzle/anime-quote-generator">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/rishabhbizzle/2-D-Naruto-Game-using-pygame-">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
